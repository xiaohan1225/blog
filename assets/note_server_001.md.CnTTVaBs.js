import{_ as i,o as a,c as n,ae as l}from"./chunks/framework.BrbCc44R.js";const o=JSON.parse('{"title":"001 初识docker","description":"","frontmatter":{"title":"001 初识docker","date":"2024-01-06T00:00:00.000Z","categories":["服务端"],"tags":["nginx"],"sidebar":"auto"},"headers":[],"relativePath":"note/server/001.md","filePath":"note/server/001.md"}'),e={name:"note/server/001.md"};function t(p,s,h,k,E,r){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h2 id="一、dockerfile" tabindex="-1">一、Dockerfile <a class="header-anchor" href="#一、dockerfile" aria-label="Permalink to &quot;一、Dockerfile&quot;">​</a></h2><p><code>Dockerfile</code> 是docker的配置文件，文件名必须叫<code>Dockerfile</code>，而且必须放在项目根目录。</p><h3 id="_1-语法" tabindex="-1">1. 语法 <a class="header-anchor" href="#_1-语法" aria-label="Permalink to &quot;1. 语法&quot;">​</a></h3><div class="language-dockerfile vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dockerfile</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 基础镜像 以哪个镜像作为基础去构建</span></span>
