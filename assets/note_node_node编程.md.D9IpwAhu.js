...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> * }</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> */</span></span></code></pre></div><ol start="2"><li>获取运行环境信息，包括运行目录、node环境、cpu架构、用户环境、系统平台</li></ol>`,6)])])}const g=a(l,[["render",p]]);export{c as __pageData,g as default};
